...
const Seo: React.FC<SEOProps> = ({ lang, url, metaDescription, keywords, title, author, image: metaImage, theme }) => {
    ...
    return (
        <Helmet>
            ...
            <meta property="og:image" content={metaImage.src} data-react-helmet="true" />
