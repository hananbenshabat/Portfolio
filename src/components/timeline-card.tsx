        ...
        <div>
            <div className="hidden lg:block">
                <div className={`flex items-center justify-between w-full mb-8  ${styling}`}>
                    ...
                    <div className="mr-2 ml-2 z-20 flex items-center order-1 h-8 bg-secondary-focus rounded-full shadow-xl">
                    ...
                    <motion.div
                        ...
                        className="order-1 w-5/12 shadow-2xl card lg:card-side text-primary-content from-base-300 via-primary bg-secondary bg-linear-to-br">
