...
export const NAME = (separator: string) =>
  FIRST_NAME +
  separator +
  GeneralFunctions.stringifyArrWithSeparator(LAST_NAME, separator);
...
export const skills: SkillsProps[] = [
  ...
  {
    id: 7,
    skill: "HTML, CSS, Tailwind CSS, daisyUI",
    level: 97,
  },
  {
    id: 8,
  ...
  {
    id: 12,
    skill: "MongoDB, CosmosDB, OracleDB",
    level: 90,
  },
  {
    id: 13,
    skill: "Selenium, Maven",
    level: 95,
  },
  {
    id: 14,
